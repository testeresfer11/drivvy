...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('company.config-setting.smtp')}}">Config Setting</a></li>
      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" id="smtp-information" action="{{route('company.config-setting.smtp')}}" method="POST">
              @csrf
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="number" class="form-control @error('port') is-invalid @enderror" id="exampleInputPort" placeholder="Port" name="port" value="{{$smtpDetail['port'] ?? ''}}">
                        @error('port')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
