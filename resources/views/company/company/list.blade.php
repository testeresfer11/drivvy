...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Companies</a></li>
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between">
            ...
            <a href="{{route('admin.user.add')}}"><button type="button" class="btn default-btn btn-md">
              <span class="menu-icon">+ Add Company</span></button></a>
          </div>
                  ...
                  <tr id={{$user->id}}>
                    ...
                    <td> 
                      <span class="menu-icon">
                        <a href="{{route('admin.company.view',['id' => $user->id])}}" title="View" class="text-primary"><i class="mdi mdi-eye"></i></a>
                      </span>&nbsp;&nbsp;&nbsp;
                      <span class="menu-icon">
                        <a href="{{route('admin.company.edit',['id' => $user->id])}}" title="Edit" class="text-success"><i class="mdi mdi-pencil"></i></a>
                      </span>&nbsp;&nbsp;
                      <span class="menu-icon">
    ...
    var user_id = $('.deleteUser').attr('data-id');
      Swal.fire({
          ...
          if (result.isConfirmed) {
              $.ajax({
                  url: "/admin/company/delete/" + user_id,
                  type: "GET", 
