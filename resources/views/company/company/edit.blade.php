...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('admin.company.list')}}">Users</a></li>
      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" id="Edit-User" action="{{route('admin.company.edit',['id' => $user->id])}}" method="POST" enctype="multipart/form-data">
              @csrf
