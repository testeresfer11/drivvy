...
@section('breadcrum')
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.user.list') }}">Companies</a></li>
...
@section('content')
    <div>
        <h4 class="user-title">View Company</h4>
        <div class="card">
            <div class="card-body">
                            ...
                            <div class="col-12 col-md-8">
                                <div class="response-data ml-4">
                                    <h6 class="f-14 mb-1"><span class="semi-bold qury">Name :</span> <span
                                            class="text-muted" id="userName">{{ $user->full_name }}</span></h6>
