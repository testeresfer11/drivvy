                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-12">
                                <div class="row user-details-data">
                                  ...
                                  <div class="col-12 col-md-3 mb-4">
                                    <h6 class="f-14 mb-1"><span class="semi-bold qury">Luggage Size :</span> <span
                                    class="text-muted" id="userName">{{ $ride->luggage_size ?? '' }}</span></h6> 
                                  </div>
                                  <div class="col-12 col-md-3 mb-4"> 
                                    <h6 class="f-14 mb-1"><span class="semi-bold qury">Smoking Allowed :</span> <span
                                    class="text-muted" id="userName">{{ $ride->smoking_allowed == '0' ? 'No' : 'Yes' }}</span></h6>  
                                  </div>
                                  <div class="col-12 col-md-3 mb-4">
                                    <h6 class="f-14 mb-1"><span class="semi-bold qury">Pets Allowed :</span> <span
                                    class="text-muted" id="userName">{{ $ride->pets_allowed == '0' ? 'No' : 'Yes' }}</span></h6>  
                                  </div>
                                  <div class="col-12 col-md-3 mb-4">
                                    <h6 class="f-14 mb-1"><span class="semi-bold qury">Music Preference :</span> <span
                                    class="text-muted" id="userName">{{ $ride->music_preference ?? '' }}</span></h6> 
                                  </div>
                                  <div class="col-12 col-md-12 mb-4"> 
                                    <h6 class="f-14 mb-1"><span class="semi-bold qury"> Description :</span> <span
                                    class="text-muted" id="userName">{{ $ride->description ?? '' }}</span></h6>   
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-12">
                                <div class="response-data car-details ml-4">
                                    ...
                                    <h6 class="f-14 mb-1"><span class="semi-bold qury">Seats :</span> <span
                                    class="text-muted" id="userName">{{ $ride->seats ?? '' }}</span></h6> 
                                </div>
                            </div>
                        </div>
