            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="welcome-title my-5">
                    <h1>Here are the details of<br> your payment.</h1>
                    <p class="fs-4 mb-0 mt-5">Booking</p>
                    <p class=" mb-0 color-80">{{$booking->seat_count}} seat</p>
                    <div class="date-time mt-5">
                      <p class="color-80">{{ \Carbon\Carbon::parse($booking->created_at)->format('l, d F Y \a\t h.iA') }}</p>
                    </div>
                  </div>
                ...
                <div class="total-text  d-flex gap-4 justify-content-center">
                    <h5 class="color-80 mb-0">Total </h5>
                    <h5 class=" mb-0 color-80 f-bold">{{$payment->amount}}</h5>
                  </div>
               <div class="ready-drive text-center border-top my-5 py-5">
                <h5 class="color-80 mb-0">  Transaction details </h5>
                <p class=" mb-0 color-80">{{ \Carbon\Carbon::parse($payment->created_at)->format('l, d F Y \a\t h.iA') }}</p>
                     <p class=" mb-0 color-80">{{$payment->transaction_id}} </p>
                 <h5 class="color-80 mb-0">  Payment Method </h5>
