                    ...
                    <div class="col-12 col-md-6">
                        <div class="card">
                            <div class="card-body px-5">
                                ...
                                <h2 class="pb-4 f-38">Forgot Password</h2>
                                <form action="{{ route('user.forget-password') }}" method="POST" id="forgetPasswordForm">
                                    @csrf
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn default-btn btn-md w-100">{{ __('Send Password Reset Link') }}</button>
                                    </div>
                                </form>
